 ...
 * BrokerLayout
 *
 * Shared sidebar layout for broker dashboard pages.
 * Mirrors AuthenticatedLayout structure but uses broker-specific navigation.
 */
...
const navItems: NavItem[] = [
  ...
  },
  {
    label: "My Traders",
    to: "/broker/traders",
    icon: (active) => <TradersIcon active={active} />,
  },
  {
    label: "Top-Ups",
    to: "/broker/topups",
